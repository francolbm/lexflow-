...
REM ============================================================
REM  Enviar a Fase 4 (escritorio cria membro + senha temporaria).
REM  Da duplo-clique.
REM ============================================================
...
git commit -m "Fase 4: escritorio PRO/PREMIUM cria Advogado/Assistente com senha temporaria (rota + UI membros)"
if errorlevel 1 (
