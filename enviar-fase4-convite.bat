...
REM ============================================================
REM  Enviar Fase 4 - convite por e-mail (com fallback de senha
REM  temporaria). Da duplo-clique.
REM ============================================================
...
git commit -m "Fase 4: convite por e-mail (inviteUserByEmail) com fallback de senha temporaria; UI membros"
if errorlevel 1 (
